...
<head>
  ...
  <?php if ( is_home() || is_front_page() ) : ?>
    <title>お問い合わせ | ふたば在宅クリニック -  墨田区、江東区、台東区の訪問診療</title>
  <?php endif; ?>
  ...
  ?>
    <title>お問い合わせ 入力 | ふたば在宅クリニック -  墨田区、江東区、台東区の訪問診療</title>
  <?php endif; ?>
  ...
  ?>
    <title>お問い合わせ 確認 | ふたば在宅クリニック -  墨田区、江東区、台東区の訪問診療</title>
  <?php endif; ?>
  ...
  ?>
    <title>お問い合わせ 完了 | ふたば在宅クリニック -  墨田区、江東区、台東区の訪問診療</title>
  <?php endif; ?>
