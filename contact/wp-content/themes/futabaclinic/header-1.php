...
<head>
  ...
  <?php if ( is_home() || is_front_page() ) : ?>
    <title>お問い合わせ | ふたば在宅クリニック - 足立区、荒川区、台東区の訪問診療</title>
  <?php endif; ?>
  ...
  ?>
    <title>お問い合わせ 入力 | ふたば在宅クリニック - 足立区、荒川区、台東区の訪問診療</title>
  <?php endif; ?>
  ...
  ?>
    <title>お問い合わせ 確認 | ふたば在宅クリニック - 足立区、荒川区、台東区の訪問診療</title>
  <?php endif; ?>
  ...
  ?>
    <title>お問い合わせ 完了 | ふたば在宅クリニック - 足立区、荒川区、台東区の訪問診療</title>
  <?php endif; ?>

  <meta name="description" content="医療法人社団 爽緑会 ふたば在宅クリニック 北千住院 東京都・城東エリアの在宅療養支援診療所 在宅医療・訪問診療・訪問看護・往診（足立区、荒川区、台東区、墨田区、葛飾区、江戸川区、江東区など）のお問い合わせになります。">
  <meta name="keywords" content="お問い合わせ,医療法人社団 爽緑会 ふたば在宅クリニック 北千住院,荒川区,在宅療養支援診療所,東京都,足立区 江戸川区,荒川区,在宅医療,訪問診療">
      ...
      <div>
        ...
        <div class="logo_box">
          <p class="pc" id="header_logo">
            <a href="/kitasenju/">
              <img src="/common/images/logo_k_e.svg" alt="医療法人社団 爽緑会 ふたば在宅クリニック 北千住院">
            </a>
          </p>
          <ul class="pc icon_box">
            <li><img src="/common/images/header_icon_03.svg" alt="在宅医療(24時間365日),医療法人社団 爽緑会 ふたば在宅クリニック 北千住院 荒川区 在宅医療 訪問診療"></li>
            <li><img src="/common/images/header_icon_02.svg" alt="内科 心・肺・脳,医療法人社団 爽緑会 ふたば在宅クリニック 北千住院 荒川区 在宅医療 訪問診療"></li>
            <li><img src="/common/images/header_icon_01.svg" alt="がん・緩和ケア,医療法人社団 爽緑会 ふたば在宅クリニック 北千住院 荒川区 在宅医療 訪問診療"></li>
          </ul>
        </div>
