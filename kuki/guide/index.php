...
<?php include($_SERVER['DOCUMENT_ROOT'] . '/include/analyticstracking.php'); ?>
	...
	<article id="wrap">
		...
		<div id="contents">
			<div id="main">
				<section>
					<p class="txt_01">当院は通院が困難な患者さんに対して、医師がご自宅を定期的に訪問して診療を行う、「<a href="/kuki/about/">在宅医療</a>」を専門とするクリニックです。</p>
					<p class="txt_02">
