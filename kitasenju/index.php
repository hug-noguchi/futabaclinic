...
<meta property="og:description" content="医療法人社団 爽緑会 ふたば在宅クリニック 北千住院 東京都・城東エリアの在宅療養支援診療所 在宅医療・訪問診療・訪問看護・往診（足立区、荒川区、台東区など）" />
...
<title>ふたば在宅クリニック - 足立区、荒川区、台東区の訪問診療</title>
<meta name="description" content="医療法人社団 爽緑会 ふたば在宅クリニック 北千住院 東京都・城東エリアの在宅療養支援診療所 在宅医療・訪問診療・訪問看護・往診（足立区、荒川区、台東区など）">
<meta name="keywords" content="医療法人社団 爽緑会 ふたば在宅クリニック,北千住院,東京都,足立区,荒川区,台東区,在宅療養支援診療所,在宅医療,訪問診療,訪問看護,往診">
...
<link rel="stylesheet" href="/kitasenju/common/styles/style.css" media="all">
<link rel="stylesheet" href="/kitasenju/top/styles/style.css" media="all">
		...
		<div id="contents_wrap">
			<div id="visual">
				<ul id="slideshow" class="pc">
						<li><img id="image03" src="../top/images/key_03.png" srcset="../top/images/key_03_2x.png 2x" alt="医療法人社団 爽緑会 ふたば在宅クリニック 北千住院,足立区 荒川区 台東区 在宅医療 訪問診療 訪問看護 往診,住み慣れたご自宅での療養をサポートいたします。" /></li>
						<li><img id="image02" src="../top/images/key_02.png" srcset="../top/images/key_02_2x.png 2x" alt="医療法人社団 爽緑会 ふたば在宅クリニック 北千住院,足立区 荒川区 台東区 在宅医療 訪問診療 訪問看護 往診,当院は在宅医療に特化したクリニックです。" /></li>
						<li>
							<img id="image01" src="../top/images/key_01.png" srcset="../top/images/key_01_2x.png 2x" alt="医療法人社団 爽緑会 ふたば在宅クリニック 北千住院,足立区 荒川区 台東区 訪問診療 訪問看護 往診,在宅医療 がん・緩和ケア 認知症・高齢者医療 内科・外科（心・肺・脳神経・糖尿病など） 24時間365日対応" />
						</li>
					</ul>
					<ul id="sp_slideshow" class="sp">
						<li>
							<img id="sp_image03" src="/top/images/sp_key_03.png"
								srcset="/top/images/sp_key_03_2x.png 2x" alt="医療法人社団 爽緑会 ふたば在宅クリニック 北千住院,足立区 荒川区 台東区 在宅医療 訪問診療 訪問看護 往診,住み慣れたご自宅での療養をサポートいたします。" />
						</li>
						<li>
						...
						<li>
							...
							srcset="/top/images/sp_key_01_2x.png 2x" alt="医療法人社団 爽緑会 ふたば在宅クリニック 北千住院,足立区 荒川区 台東区 訪問診療 訪問看護 往診,在宅医療 がん・緩和ケア 認知症・高齢者医療 内科・外科（心・肺・脳神経・糖尿病など） 24時間365日対応" />
						</li>
					</ul>
			</div>
			<div id="contents">
				<div id="main">
					<section id="open_box">
						...
						<div class="txt_box_01">
							...
							<div class="line_right">
								<div class="txt_box_02">
									...
									<div class="photo_kukiin">
										<img src="/kitasenju/common/images/kukiin_picture_v2.jpg" srcset="/kitasenju/common/images/kukiin_picture_2x_v2.jpg" alt="医療法人社団 爽緑会 ふたば在宅クリニック 埼玉院">
									</div>
									<ul>
										<li>久喜市</li>
										<li>加須市</li>
							...
							<div class="txt_box_sakura">
								...
								<div class="photo_sakura">
									<img src="/top/images/sakura_picture.jpg" srcset="/top/images/sakura_picture_2x.jpg" alt="佐倉院">
								</div>
								<ul>
									<li>佐倉市</li>
									<li>印西市</li>
						...
						<div class="teacher_box">
							<img src="/top/images/teacher_04.jpg" srcset="/top/images/teacher_04_2x.jpg 2x" alt="医療法人社団 爽緑会 ふたば在宅クリニック 北千住院,足立区 荒川区 台東区 在宅医療 訪問診療 訪問看護 往診">
						</div>
					</section>
					<section id="sec_01">
						<div>
							...
							<p><a href="/kitasenju/about/">「在宅医療とは？」</a></p>
						</div>
					</section>
					...
					<section id="sec_02" class="tokushoku">
						<h2>当院の特色</h2>
						<div class="lead">
							<p>「ふたば式」在宅医療</p>
							<p class="lead_txt pc">
