...
<?php include($_SERVER['DOCUMENT_ROOT'] . '/include/analyticstracking.php'); ?>
	...
	<article id="wrap">
		...
		<div id="visual">
			<p>
				<img class="pc" src="/common/images/message_key.jpg" srcset="/common/images/message_key_2x.jpg 2x" loading=”lazy” alt="理事長挨拶・スタッフ紹介">
				<img class="sp" src="/common/images/message_sp_key.jpg" srcset="/common/images/message_sp_key_2x.jpg 2x" loading=”lazy” alt="理事長挨拶・スタッフ紹介">
			</p>
		</div>
		<div id="contents">
			<div id="main">
					...
					<div class="box_wrap">
						...
						<div class="txt_box_02">
							...
							<p>
								...
								そのため、2021年以降、東京六本木に本部を設置し、東京（北千住・新小岩）、千葉（佐倉・八千代）と、分院展開を進めております。<br>
