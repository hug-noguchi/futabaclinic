...
<title>在宅診療とは | ふたば在宅クリニック - 八千代市、千葉市の訪問診療</title>
<meta name="description" content="ふたば在宅クリニック 八千代院（八千代市、千葉市、印西市、四街道市、佐倉市、酒々井町）千葉県・北西部・印旛地域の訪問診療・往診・在宅医療">
<meta name="keywords" content="在宅診療とは、ふたば在宅クリニック,在宅療養支援診療所,千葉県,北西部地域">
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/drawer/3.1.0/css/drawer.min.css">
<link rel="stylesheet" type="text/css" href="/common/styles/base.css" media="all">
<link rel="stylesheet" type="text/css" href="/about/styles/style.css" media="all">
<link rel="stylesheet" type="text/css" href="/yachiyo/about/styles/style.css" media="all">
		...
		<div id="contents">
			<div id="main">
				...
				<section>
					...
					<p class="last">
						詳しくはお気軽に<span><a href="/contact/input_yachiyo/">お問い合わせ</a></span>ください。
					</p>
				</section>
				<section>
					<h2>在宅診療の流れ</h2>
					<ul>
						<li>
							<dl>
								...
								<dd>
									<p>
									在宅医療をお考えの方、詳細だけでも聞いてみたい方はまずは、一度お電話&nbsp;<a href="tel:0474093677" class="tel-link">047-409-3677</a>
									&nbsp;でご相談ください。
									</p>
									<p>
										<a href="/contact/input_yachiyo/#form" class="text-link">お問い合わせメール</a>
									、お申し込み書FAXでもかまいません。
									</p>
									<p>
