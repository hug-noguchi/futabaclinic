...
<head>
	...
	<title>当院について | ふたば在宅クリニック -  墨田区、江東区、台東区の訪問診療</title>
	...
	-->
	<meta name="thumbnail" content="https://www.futabaclinic.jp/kinshichou/common/images/kinshichou_picture_02_100.jpg"/>
	<style>
		.address span:first-child {
			display: block;
			margin-bottom: 10px;
		}
		#main section:nth-child(2) .lead {
			margin: 30px 0 60px !important;
			position: relative;
		}
		#main section:nth-child(2) .lead p:first-child {
			background-color: rgba(88,183,238,1);
			border-radius: 20px;
			color: #fff;
			font-size: 20px;
			font-weight: bold;
...
<body id="guide" class="preload drawer drawer--top">
	...
	<article id="wrap">
		...
		<div id="visual">
			<p>
				<img class="pc" src="/common/images/guide_key.jpg" srcset="/common/images/guide_key_2x.jpg 2x" alt="当院について,医療法人社団 爽緑会 ふたば在宅クリニック 錦糸町院,墨田区 江東区 台東区 葛飾区 江戸川区 足立区 荒川区 在宅医療 訪問診療 訪問看護 往診">
				<img class="sp" src="/common/images/guide_sp_key_2x.jpg" alt="当院について,医療法人社団 爽緑会 ふたば在宅クリニック 錦糸町院,墨田区 江東区 台東区 葛飾区 江戸川区 足立区 荒川区 在宅医療 訪問診療 訪問看護 往診">
			</p>
		</div>
		<div id="contents">
			<div id="main">
				<section>
					<p class="txt_01">当院は通院が困難な患者さんに対して、医師がご自宅を定期的に訪問して診療を行う、「<a href="/kinshichou/about/">在宅医療</a>」を専門とするクリニックです。</p>
					<p class="txt_02">
				...
				<section>
					...
					<div>
						<h3><span>動く病院<br>&nbsp;&nbsp;- 24時間365日 医師が対応 -</span></h3>
						<div class="pink">
							<p>
    			...
    			<div class="gallery_shinkoiwa">
					...
					<div class="gallery_roppongi">
						...
						<ul>
							<li>
								<figure class="mr">
									<img src="/common/images/gallery_roppongi_1.jpg" loading="”lazy”" alt="">
									<figcaption class="tal">外観</figcaption>
								</figure>
								<figure class="ml">
									<img src="/common/images/gallery_roppongi_3.jpg" loading="”lazy”" alt="">
									<figcaption class="tal">外観（六本木ヒルズ）</figcaption>
								</figure>
								<figure class="ml">
									<img src="/common/images/gallery_roppongi_4.jpg" loading="”lazy”" alt="">
				...
				<section id="access">
					...
					<p class="txt_01">本八幡院：本八幡駅徒歩3分です。</p>
					<div class="map_box">
