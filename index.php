...
<meta property="og:description" content="医療法人社団 爽緑会・千葉爽緑会 ふたば在宅クリニック東京都 北千住院 城東エリア（足立区、荒川区、台東区）、新小岩院（葛飾区、江戸川区、墨田区、江東区）、埼玉県 久喜院（久喜市、加須市、幸手市、杉戸町、宮代町、白岡市、蓮田市、春日部市、伊奈町、五霞町）・千葉県 佐倉院（佐倉市、四街道市、八千代市、印西市、千葉市、酒々井町）" />
...
<title>医療法人社団 爽緑会・千葉爽緑会 ふたば在宅クリニック | 東京都・埼玉県・千葉県の在宅療養支援診療所</title>
...
<?php include($_SERVER['DOCUMENT_ROOT'] . '/include/analyticstracking.php'); ?>
	...
	<article id="wrap">
		<div id="contents_wrap">
			...
			<section class="sec_01 maru wow fadeIn delay-1s" data-wow-duration="2s">
			...
			<div id="contents">
				<div id="main">
					<div class="map_top maru wow fadeIn delay-1s" data-wow-duration="8s" style="visibility: visible; animation-duration: 8s; animation-name: fadeIn;">
						<img src="/top/images/recruit_map.png" alt="医療法人社団 爽緑会・千葉爽緑会 ふたば在宅クリニック 六本木本部 埼玉久喜院 北千住院 佐倉院 八千代院">
					</div>

			<section id="bunin_box" class="maru wow fadeIn delay-2s" data-wow-duration="2s">
				<div class="txt_box_01">
					<p class="tit_01">お問い合わせ・詳細は各院ホームページから</p>
				</div>
				<div class="txt_box_00">
					<div class="txt_box_05">
						<a class="title" href="tel:0358430151">
						...
						<p class="txt_20">取材、求人についてはこちら</p>
						<p class="txt_21">
			...
			<section id="message">
				...
				<div class="box_wrap">
					...
					<div class="txt_box_02">
						<p>
							皆様、ふたば在宅クリニックのホームページをご覧いただきありがとうございます。理事長の石井成伸と申します。
						</p>
						<p>
							私は、これまで東京女子医科大学病院、済生会病院などの急性期総合病院に勤務し、内科、呼吸器科、救急医療、がん治療・緩和ケアを中心に診療をしてまいりました。<br>
							...
							また、急性期総合病院は長期入院が困難になっており、行き場を失う患者様も残念ながら少なくありませんでした。<br>
						...
						<p>
							そこで、2017年6月に、当時勤務していた済生会病院のあった埼玉県久喜市に「ふたば在宅クリニック」を開院しました。<br>
						...
						<p>
							当法人の特徴としましては、各科の学会認定専門医を中心に、皮膚科・精神科に至るまで、複数科の医師を配置し、総合病院のような質の高いチーム医療を提供していることです。<br>
							もちろん在宅医療は看取りだけが全てではありませんが、グループ全体での年間看取り数も500人を超すようになり、全国有数の在宅診療所に成長できたと自負しております。
						</p>
						<p>
							各院、地域の病院や訪問看護師さん・薬剤師さん・ケアマネージャーさんと連携を取り、一般内科疾患、心・肺・脳神経・整形疾患、がん終末期、認知症などの診療に力を入れております。
						</p>
						<p>
			...
			<section id="ishi">
					...
					<ul class="docter-lists">
						<li>
							<dl>
								<dt>石井 成伸（統括）</dt>
								<dd>
									<img src="/top/images/person_01.jpg" alt="石井 成伸,医療法人社団 爽緑会・千葉爽緑会 ふたば在宅クリニック 埼玉院（久喜市、加須市、幸手市、杉戸町、宮代町、白岡市、蓮田市、春日部市、伊奈町、五霞町）、東京 北千住院（足立区、荒川区、台東区）、東京 新小岩院（葛飾区、江戸川区、墨田区、江東区）、千葉 佐倉院（佐倉市、四街道市、八千代市、印西市、千葉市、酒々井町）在宅医療 訪問診療 訪問看護 往診" class="img">
									<ul class="txt">
						...
						<li>
							<dl>
								<dt>下田 学（埼玉）</dt>
								<dd>
								<img src="/top/images/person_shimoda.jpg" alt="下田 学,医療法人社団 爽緑会・千葉爽緑会 ふたば在宅クリニック埼玉院（久喜市、加須市、幸手市、杉戸町、宮代町、白岡市、蓮田市、春日部市、伊奈町、五霞町）在宅医療 訪問診療 訪問看護 往診" class="img">
									<ul class="txt">
										<li>日本呼吸器学会認定 呼吸器専門医</li>
										<li>日本内科学会認定 内科認定医</li>
										<li>日本結核・非結核性抗酸菌症学会認定医</li>
										<li>日本エイズ学会認定医</li>
									</ul>
								</dd>
							</dl>
						...
						<li>
							<dl>
								<dt>山本 真（埼玉）</dt>
								<dd>
									<img src="/top/images/person_yamamoto.jpg" alt="山本 真,医療法人社団 爽緑会・千葉爽緑会 ふたば在宅クリニック 埼玉院（久喜市、加須市、幸手市、杉戸町、宮代町、白岡市、蓮田市、春日部市、伊奈町、五霞町）在宅医療 訪問診療 訪問看護 往診" class="img">
									<ul class="txt">
										<li>日本外科学会認定医</li>
						...
						<li>
							<dl>
								<dt>石塚 理人（東京）</dt>
								<dd>
									<img src="/top/images/person_ishiduka.jpg" alt="石塚 理人,医療法人社団 爽緑会・千葉爽緑会 ふたば在宅クリニック 東京 北千住院（足立区、荒川区、台東区）、東京 新小岩院（葛飾区、江戸川区、墨田区、江東区）在宅医療 訪問診療 訪問看護 往診" class="img">
									<ul class="txt">
										<li>日本循環器学会認定 循環器専門医</li>
										<li>日本内科学会総合内科専門医</li>
										<li>博士号（医学）</li>
						...
						<li>
							<dl>
								<dt>穂積 淳（東京）</dt>
								<dd>
									<img src="/top/images/person_hoseki.jpg" alt="穂積 淳,医療法人社団 爽緑会・千葉爽緑会 ふたば在宅クリニック 東京 北千住院（足立区、荒川区、台東区）、東京 新小岩院（葛飾区、江戸川区、墨田区、江東区）在宅医療 訪問診療 訪問看護 往診" class="img">
									<ul class="txt">
										<li>麻酔科認定医・専門医・指導医</li>
										<li>日本ペインクリニック学会専門医</li>
										<li>JB-POT・Advanced PTEexam</li>
										<li>日本医師会認定産業医</li>
									</ul>
								</dd>
							</dl>
						...
						<li>
							<dl>
								<dt>小林 秀嘉（東京）</dt>
								<dd>
									<!-- <img src="/top/images/" alt="小林 秀嘉,医療法人社団 爽緑会・千葉爽緑会 ふたば在宅クリニック 東京 北千住院（足立区、荒川区、台東区）、東京 新小岩院（葛飾区、江戸川区、墨田区、江東区）在宅医療 訪問診療 訪問看護 往診" class="img">
									<ul class="txt"> -->
									<ul>
										<li>日本医師会認定産業医</li>
									</ul>
					...
					<ul class="docter-lists">
						<li>
							<dl>
								<dt>本部長 秋谷 智広</dt>
								<dd>
									<img src="/top/images/person_04.jpg" alt="本部長 秋谷 智広,医療法人社団 爽緑会・千葉爽緑会 ふたば在宅クリニック 埼玉院（久喜市、加須市、幸手市、杉戸町、宮代町、白岡市、蓮田市、春日部市、伊奈町、五霞町）、東京 北千住院（足立区、荒川区、台東区）、東京 新小岩院（葛飾区、江戸川区、墨田区、江東区）、千葉 佐倉院（佐倉市、四街道市、八千代市、印西市、千葉市、酒々井町）" class="img" >
								</dd>
							</dl>
						</li>
						<li>
							<dl>
								<dt>次長 片寄 貴友</dt>
								<dd>
									<img src="/top/images/person_katayose.jpg" loading=”lazy” alt="ふたば在宅クリニック 次長 片寄 貴友" class="img" >
								</dd>
							</dl>
						</li>
					</ul>
					...
					<ul class="docter-lists">
						<li>
							<dl>
								<dt>室長 斉藤 恵介</dt>
								<dd>
									<img src="/top/images/person_saitou-k.jpg" alt="室長 斉藤 恵介,医療法人社団 爽緑会・千葉爽緑会 ふたば在宅クリニック 埼玉院（久喜市、加須市、幸手市、杉戸町、宮代町、白岡市、蓮田市、春日部市、伊奈町、五霞町）、東京 北千住院（足立区、荒川区、台東区）、東京 新小岩院（葛飾区、江戸川区、墨田区、江東区）、千葉 佐倉院（佐倉市、四街道市、八千代市、印西市、千葉市、酒々井町）" class="img" >
								</dd>
							</dl>
						</li>
						<li class="pink">
						...
						<li class="pink">
							<dl>
								<dt>地域連携看護師 中野 留美</dt>
								<dd>
									<img src="/top/images/person_nakano.jpg" alt="地域連携看護師 中野 留美,医療法人社団 爽緑会・千葉爽緑会 ふたば在宅クリニック 東京 新小岩院（葛飾区、江戸川区、墨田区、江東区）" class="img">
								</dd>
							</dl>
						</li>
					</ul>
					...
					<ul class="docter-lists">
						<li class="pink">
							<dl>
								<dt>看護部長 榎 美鈴</dt>
								<dd>
									<img src="/top/images/person_05.jpg" alt="看護部長 榎 美鈴,医療法人社団 爽緑会・千葉爽緑会 ふたば在宅クリニック 埼玉院（久喜市、加須市、幸手市、杉戸町、宮代町、白岡市、蓮田市、春日部市、伊奈町、五霞町）" class="img" >
								</dd>
							</dl>
						</li>
					</ul>
				...
				<section id="kanren_sec02" class="kyuujin">
					...
					<p class="kyuujin_txt">紹介会社を介さず、直接採用に至った方には、<strong>お祝い金</strong>（基本給の1ヶ月分相当）を6カ月以上勤務後に賞与とあわせて贈呈致します。<br>
					※看護師、医師に限る<br><br>
				...
				<section id="houjin">
					...
					<div class="top_gallery">
						...
						<ul>
							<li>
								<figure class="mr">
									<img src="/common/images/gallery_5.jpg" alt="久喜院 外観">
									<figcaption class="tal">外観</figcaption>
								</figure>
								<figure class="ml">
									<img src="/common/images/gallery_kuki_3.jpg" alt="久喜院 受付">
									<figcaption class="tar">受付</figcaption class="tal">
								</figure>
						</li>
							<li>
									<figure class="mr">
										<img src="/common/images/gallery_kuki.jpg" alt="久喜院 診療室">
										<figcaption class="tal">診療室</figcaption>
									</figure>
									<figure class="ml">
										<img src="/common/images/gallery_kuki_2.jpg" alt="久喜院 医局">
					...
					<div class="top_gallery">
						...
						<ul>
							...
							<li>
								...
								<figure class="ml">
									<img src="/common/images/gallery_sakura_4.jpg" alt="佐倉院 休憩室">
									<figcaption class="tar">休憩室</figcaption class="tal">
								</figure>
							</li>
						</ul>
