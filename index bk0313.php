					...
					<ul class="docter-lists">
						...
						<li>
							<dl>
								<dt>鈴木 亮（埼玉）</dt>
								<dd>
									<img src="/common/images/person_suzuki.jpg" alt="鈴木 亮,医療法人社団 爽緑会・千葉爽緑会 ふたば在宅クリニック" class="img">
									<ul class="txt">
										<li>心臓血管外科専門医</li>
										<li>外科専門医</li>
										<li>慶応大学外科学大学院博士号</li>
						...
						<li>
							<dl>
								<dt>小林 秀嘉（東京）</dt>
								<dd>
									<img src="/common/images/person_kobayashi.jpg" alt="小林 秀嘉,医療法人社団 爽緑会・千葉爽緑会 ふたば在宅クリニック" class="img">
									<ul class="txt">
										<li>日本医師会認定産業医</li>
									</ul>
								</dd>
