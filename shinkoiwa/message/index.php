...
<head>
	...
	<title>理事長挨拶 | ふたば在宅クリニック -  葛飾区、江戸川区、墨田区の訪問診療</title>
	...
	<link rel="stylesheet" type="text/css" href="/shinkoiwa/message/styles/style.css" media="all">
	...
	-->
	<meta name="thumbnail" content="https://www.futabaclinic.jp/shinkoiwa/common/images/shinkoiwa_picture_02_100.jpg"/>
	<style>
		.txt_lead {
			color: #f48a9d;
			font-weight: bold;
...
<?php include($_SERVER['DOCUMENT_ROOT'] . '/include/analyticstracking.php'); ?>
	...
	<article id="wrap">
		...
		<div id="visual">
			<p>
				<img class="pc" src="/common/images/message_key.jpg" srcset="/common/images/message_key_2x.jpg 2x" alt="理事長挨拶,医療法人社団 爽緑会 ふたば在宅クリニック 新小岩院,葛飾区 江戸川区 墨田区 江東区 在宅医療 訪問診療 訪問看護 往診">
				<img class="sp" src="/common/images/message_sp_key.jpg" srcset="/common/images/message_sp_key_2x.jpg 2x" alt="理事長挨拶,医療法人社団 爽緑会 ふたば在宅クリニック 新小岩院,葛飾区 江戸川区 墨田区 江東区 在宅医療 訪問診療 訪問看護 往診">
			</p>
		</div>
		<div id="contents">
			<div id="main">
				<section>
					...
					<div class="box_wrap">
						<div class="box">
							<img class="pc" src="/common/images/message_photo_01.jpg" srcset="/common/images/message_photo_01_2x.jpg 2x" alt="理事長 石井 成伸,医療法人社団 爽緑会 ふたば在宅クリニック 新小岩院,葛飾区 江戸川区 墨田区 江東区 在宅医療 訪問診療 訪問看護 往診" loading="lazy">
							<img class="sp" src="/common/images/message_sp_photo_01.jpg" srcset="/common/images/message_sp_photo_01_2x.jpg 2x" alt="理事長 石井 成伸,医療法人社団 爽緑会 ふたば在宅クリニック 新小岩院,葛飾区 江戸川区 墨田区 江東区 在宅医療 訪問診療 訪問看護 往診" loading="lazy">
							<div class="txt_box">
								<h3>
									<span class="border">
					...
					<ul class="docter-lists">
						<li>
							<dl>
								<dt>石井 成伸</dt>
								<dd>
									<img src="/common/images/message_person_01.jpg" alt="石井 成伸,医療法人社団 爽緑会 ふたば在宅クリニック 新小岩院,葛飾区 江戸川区 墨田区 江東区 在宅医療 訪問診療 訪問看護 往診" class="img" loading="lazy">
									<ul class="txt">
						...
						<li>
							<dl>
								<dt>石塚 理人</dt>
								<dd>
									<img src="/shinkoiwa/message/images/person_ishiduka.jpg" alt="石塚 理人,医療法人社団 爽緑会 ふたば在宅クリニック 新小岩院,葛飾区 江戸川区 墨田区 江東区 在宅医療 訪問診療 訪問看護 往診" class="img" loading="lazy">
									<ul class="txt">
						...
						<li>
							<dl>
								<dt>井之輪 俊彦</dt>
								<dd>
									<img src="/shinkoiwa/message/images/person_inowa_v3.jpg" alt="井之輪 俊彦,医療法人社団 爽緑会 ふたば在宅クリニック 新小岩院,葛飾区 江戸川区 墨田区 江東区 在宅医療 訪問診療 訪問看護 往診" class="img" loading="lazy">
									<ul class="txt">
					...
					<ul class="docter-lists">
						<li>
							<dl>
								<dt>小林 秀嘉</dt>
								<dd>
								<!-- <img src="/kitasenju/message/images/" alt="小林 秀嘉,医療法人社団 爽緑会 ふたば在宅クリニック 新小岩院,葛飾区 江戸川区 墨田区 江東区 在宅医療 訪問診療 訪問看護 往診" class="img">
									<ul class="txt"> -->
									<ul>
										<li>日本医師会認定産業医</li>
									</ul>
					...
					<ul class="docter-lists">
						<li>
							<dl>
								<dt>穂積 淳</dt>
								<dd>
									<img src="/shinkoiwa/message/images/person_hoseki.jpg" alt="穂積 淳,医療法人社団 爽緑会 ふたば在宅クリニック 新小岩院,葛飾区 江戸川区 墨田区 江東区 在宅医療 訪問診療 訪問看護 往診" class="img" loading="lazy">
									<ul class="txt">
									<ul>
					...
					<ul>
						...
						<li class="pink">
							<dl>
								<dt>地域連携看護師 中野 留美</dt>
								<dd>
									<img src="/shinkoiwa/message/images/person_nakano.jpg" alt="地域連携看護師 中野 留美" class="img" loading="lazy">
								</dd>
							</dl>
						</li>
					</ul>
