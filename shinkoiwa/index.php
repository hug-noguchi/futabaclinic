		...
		<div id="contents_wrap">
			<div id="visual">
				<ul id="slideshow" class="pc">
					<li>
						<img id="image03" src="../top/images/key_03.png" srcset="../top/images/key_03_2x.png 2x" alt="ふたば在宅クリニック 新小岩院（葛飾区、江戸川区、墨田区、江東区など）東京都・城東エリアの在宅医療 訪問診療 往診、住み慣れたご自宅での療養をサポートいたします。" />
					</li>
					<li>
						<img id="image02" src="../top/images/key_02.png" srcset="../top/images/key_02_2x.png 2x" alt="ふたば在宅クリニック 新小岩院（葛飾区、江戸川区、墨田区、江東区など）東京都・城東エリアの在宅医療 訪問診療 往診、当院は在宅医療に特化したクリニックです。" />
					</li>
					<li>
						<img id="image01" src="../top/images/key_01.png" srcset="../top/images/key_01_2x.png 2x" alt="ふたば在宅クリニック 新小岩院（葛飾区、江戸川区、墨田区、江東区など）東京都・城東エリアの在宅医療 訪問診療 往診、在宅医療 がん・緩和ケア 認知症・高齢者医療 内科・外科（心・肺・脳神経・糖尿病など） 24時間365日対応" />
					</li>
				</ul>
				<ul id="sp_slideshow" class="sp">
				<li>
					<img id="sp_image03" src="/top/images/sp_key_03.png"
						srcset="/top/images/sp_key_03_2x.png 2x" alt="ふたば在宅クリニック 新小岩院（葛飾区、江戸川区、墨田区、江東区など）東京都・城東エリアの在宅医療 訪問診療 往診、住み慣れたご自宅での療養をサポートいたします。" />
					</li>
					<li>
						<img id="sp_image02" src="/top/images/sp_key_02.png"
							srcset="/top/images/sp_key_02_2x.png 2x" alt="ふたば在宅クリニック 新小岩院（葛飾区、江戸川区、墨田区、江東区など）東京都・城東エリアの在宅医療 訪問診療 往診、当院は在宅医療に特化したクリニックです。" />
					</li>
					<li>
						<img id="sp_image01" src="/top/images/sp_key_01.png"
							srcset="/top/images/sp_key_01_2x.png 2x" alt="ふたば在宅クリニック 新小岩院（葛飾区、江戸川区、墨田区、江東区など）東京都・城東エリアの在宅医療 訪問診療 往診、在宅医療 がん・緩和ケア 認知症・高齢者医療 内科・外科（心・肺・脳神経・糖尿病など） 24時間365日対応" />
					</li>
				</ul>
			</div>
			<div id="contents">
