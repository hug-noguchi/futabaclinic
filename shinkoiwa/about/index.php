...
<head>
	...
	<link rel="stylesheet" type="text/css" href="/shinkoiwa/about/styles/style.css" media="all">
		...
		<div id="contents">
			<div id="main">
				...
				<section>
					...
					<p class="last">
						詳しくはお気軽に<span><a href="/contact/input_shinkoiwa/#form">お問い合わせ</a></span>ください。
					</p>
				</section>
				<section>
					<h2>在宅診療の流れ</h2>
					<ul>
						<li>
							<dl>
								...
								<dd>
									<p>
									在宅医療をお考えの方、詳細だけでも聞いてみたい方はまずは、一度お電話&nbsp;<a href="tel:0358793530" class="tel-link">03-5879-3530</a>
									&nbsp;でご相談ください。
									</p>
									<p>
										<a href="/contact/input_shinkoiwa/#form" class="text-link">お問い合わせメール</a>
										、お申し込み書FAXでもかまいません。
									</p>
									<p>
