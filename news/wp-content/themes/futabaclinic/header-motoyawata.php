...
<head>
  ...
  <title><?php the_title_attribute(); ?> | お知らせ一覧 | ふたば在宅クリニック - 市川市の訪問診療</title>
  <meta name="description" content="ふたば在宅クリニック 本八幡院（市川市、船橋市、習志野市、八千代市、千葉市、印西市、佐倉市、四街道市、酒々井町）千葉県・北西部・印旛地域の訪問診療・往診・在宅医療のお知らせ「<?php the_title_attribute(); ?> 」になります。">
  <meta name="keywords" content="<?php the_title_attribute(); ?> ,お知らせ一覧,医療法人社団 爽緑会 ふたば在宅クリニック 本八幡院,在宅療養支援診療所,千葉県,船橋市,習志野市">
  ...
  <div class="nav pc">
    ...
    <ul id="breadcrumb">
			...
			<?php if(!is_home() && is_single()): ?>
			  <li><a href="/news/motoyawata/">お知らせ一覧</a>&nbsp;&gt;&nbsp;</li>
