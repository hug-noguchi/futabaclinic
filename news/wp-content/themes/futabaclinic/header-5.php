...
<head>
  ...
  <?php if(is_single()): ?>
    <title><?php the_title_attribute(); ?> | お知らせ一覧 | ふたば在宅クリニック - 東京都・埼玉県・千葉県の在宅訪問診療所</title>
    <meta name="description" content="医療法人社団 爽緑会・千葉爽緑会 ふたば在宅クリニック東京都 北千住院 城東エリア（墨田区、江東区、台東区、葛飾区、江戸川区、足立区、荒川区）、新小岩院（墨田区、江東区、台東区、葛飾区、江戸川区、足立区、荒川区）、錦糸町院（墨田区、江東区、台東区、葛飾区、江戸川区、足立区、荒川区）、埼玉県 久喜院（久喜市、加須市、幸手市、杉戸町、宮代町、白岡市、蓮田市、春日部市、伊奈町、五霞町）・千葉県 佐倉院（佐倉市、印西市、四街道市、八千代市、千葉市、酒々井町、習志野市、船橋市）訪問診療・往診・在宅医療のお知らせ「<?php the_title_attribute(); ?> 」になります。">
    <meta name="keywords" content="<?php the_title_attribute(); ?> ,お知らせ一覧,医療法人社団 爽緑会 ふたば在宅クリニック,在宅療養支援診療所,在宅医療,訪問診療,訪問看護,往診">
  <?php else: ?>
    <title>お知らせ一覧 | ふたば在宅クリニック - 東京都・埼玉県・千葉県の在宅訪問診療所</title>
    <meta name="description" content="医療法人社団 爽緑会・千葉爽緑会 ふたば在宅クリニック東京都 北千住院 城東エリア（墨田区、江東区、台東区、葛飾区、江戸川区、足立区、荒川区）、新小岩院（墨田区、江東区、台東区、葛飾区、江戸川区、足立区、荒川区）、錦糸町院（墨田区、江東区、台東区、葛飾区、江戸川区、足立区、荒川区）、埼玉県 久喜院（久喜市、加須市、幸手市、杉戸町、宮代町、白岡市、蓮田市、春日部市、伊奈町、五霞町）・千葉県 佐倉院（佐倉市、印西市、四街道市、八千代市、千葉市、酒々井町、習志野市、船橋市）在宅医療 訪問診療 訪問看護 往診">
