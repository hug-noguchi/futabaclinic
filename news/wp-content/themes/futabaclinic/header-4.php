...
<head>
  ...
  <?php if(is_single()): ?>
    <title><?php the_title_attribute(); ?> | お知らせ一覧 | ふたば在宅クリニック - 八千代市、千葉市の訪問診療</title>
    <meta name="description" content="ふたば在宅クリニック 八千代院（八千代市、千葉市、習志野市、船橋市、印西市、佐倉市、四街道市、酒々井町）千葉県・北西部・印旛地域の訪問診療・往診・在宅医療のお知らせ「<?php the_title_attribute(); ?> 」になります。">
    <meta name="keywords" content="<?php the_title_attribute(); ?> ,お知らせ一覧,医療法人社団 爽緑会 ふたば在宅クリニック 八千代院,在宅療養支援診療所,千葉県,八千代市,千葉市">
  <?php else: ?>
    <title>お知らせ一覧 | ふたば在宅クリニック - 八千代市、千葉市の訪問診療</title>
    <meta name="description" content="ふたば在宅クリニック 八千代院（八千代市、千葉市、習志野市、船橋市、印西市、佐倉市、四街道市、酒々井町）千葉県・北西部・印旛地域の訪問診療・往診・在宅医療">
    <meta name="keywords" content="お知らせ一覧,医療法人社団 爽緑会 ふたば在宅クリニック 八千代院,在宅療養支援診療所,千葉県,八千代市,千葉市,在宅医療,訪問診療">
  <?php endif; ?>
      ...
      <div class="right">
        ...
        <div class="contact_box">
          <div class="contact_box_in">
            <p class="tel"><a href="tel:0474093677" class="abled">047-409-3677</a></p>
  ...
  <div class="nav pc">
    ...
    <ul id="breadcrumb">
			...
			<?php if(!is_home() && is_single()): ?>
			  <li><a href="/news/yachiyo/">お知らせ一覧</a>&nbsp;&gt;&nbsp;</li>
