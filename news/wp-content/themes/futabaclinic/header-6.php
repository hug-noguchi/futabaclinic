...
<head>
  ...
  <?php if(is_single()): ?>
    <title><?php the_title_attribute(); ?> | お知らせ一覧 | ふたば在宅クリニック -  墨田区、江東区、台東区の訪問診療</title>
    <meta name="description" content="ふたば在宅クリニック 錦糸町院（墨田区、江東区、台東区、葛飾区、江戸川区、足立区、荒川区など）東京都・城東エリアの訪問診療・往診・在宅医療のお知らせ「<?php the_title_attribute(); ?> 」になります。">
    <meta name="keywords" content="<?php the_title_attribute(); ?> ,ふたば在宅クリニック 錦糸町院,東京都,墨田区,江東区,台東区,葛飾区,江戸川区,足立区,荒川区,在宅医療,訪問診療,往診">
  <?php else: ?>
    <title>お知らせ一覧 | ふたば在宅クリニック -  墨田区、江東区、台東区の訪問診療</title>
    <meta name="description" content="ふたば在宅クリニック 錦糸町院（墨田区、江東区、台東区、葛飾区、江戸川区、足立区、荒川区など）東京都・城東エリアの訪問診療・往診・在宅医療のお知らせ一覧になります。">
      ...
      <div>
        ...
        <div class="logo_box">
          ...
          <ul class="icon_box pc">
            <li><img src="/common/images/header_icon_03.svg" alt="在宅医療(24時間365日),ふたば在宅クリニック 錦糸町院,東京都・城東エリア（墨田区、江東区、台東区、葛飾区、江戸川区、足立区、荒川区など）の訪問診療・往診・在宅医療"></li>
            <li><img src="/common/images/header_icon_02.svg" alt="内科 心・肺・脳,ふたば在宅クリニック 錦糸町院,東京都・城東エリア（墨田区、江東区、台東区、葛飾区、江戸川区、足立区、荒川区など）の訪問診療・往診・在宅医療"></li>
            <li><img src="/common/images/header_icon_01.svg" alt="がん・緩和ケア,ふたば在宅クリニック 錦糸町院,東京都・城東エリア（墨田区、江東区、台東区、葛飾区、江戸川区、足立区、荒川区など）の訪問診療・往診・在宅医療"></li>
          </ul>
        </div>
  ...
  <div class="nav pc">
    ...
    <ul id="breadcrumb">
			...
			<?php if(!is_home() && is_single()): ?>
			  <li><a href="/news/kinshichou/">お知らせ一覧</a>&nbsp;&gt;&nbsp;</li>
