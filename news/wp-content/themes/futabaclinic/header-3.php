...
<head>
  ...
  <?php if(is_single()): ?>
    <title><?php the_title_attribute(); ?> | お知らせ一覧 | ふたば在宅クリニック - 佐倉市、印西市、四街道市の訪問診療</title>
    <meta name="description" content="ふたば在宅クリニック 佐倉院（佐倉市、印西市、四街道市、八千代市、千葉市、酒々井町、習志野市、船橋市）千葉県・北西部・印旛地域の訪問診療・往診・在宅医療のお知らせ「<?php the_title_attribute(); ?> 」になります。">
    <meta name="keywords" content="<?php the_title_attribute(); ?> ,お知らせ一覧,医療法人社団 爽緑会 ふたば在宅クリニック 佐倉院,在宅療養支援診療所,千葉県,佐倉市,四街道市">
  <?php else: ?>
    <title>お知らせ一覧 | ふたば在宅クリニック - 佐倉市、印西市、四街道市の訪問診療</title>
    <meta name="description" content="ふたば在宅クリニック 佐倉院（佐倉市、印西市、四街道市、八千代市、千葉市、酒々井町、習志野市、船橋市））千葉県・北西部・印旛地域の訪問診療・往診・在宅医療">
    <meta name="keywords" content="お知らせ一覧,医療法人社団 爽緑会 ふたば在宅クリニック 佐倉院,在宅療養支援診療所,千葉県,佐倉市,四街道市,八千代市,印西市,在宅医療,訪問診療">
  <?php endif; ?>
      ...
      <div>
        ...
        <div class="logo_box">
          ...
          <ul class="icon_box pc">
            <li>
              <img src="/common/images/header_icon_03.svg" alt="在宅医療(24時間365日),ふたば在宅クリニック 佐倉院,千葉県・印旛地域（佐倉市、印西市、四街道市、八千代市、千葉市、酒々井町、習志野市、船橋市）の訪問診療・往診・在宅医療">
            </li>
            <li>
              <img src="/common/images/header_icon_02.svg" alt="内科 心・肺・脳,ふたば在宅クリニック 佐倉院,千葉県・印旛地域（佐倉市、印西市、四街道市、八千代市、千葉市、酒々井町、習志野市、船橋市）の訪問診療・往診・在宅医療">
            </li>
            <li>
              <img src="/common/images/header_icon_01.svg" alt="がん・緩和ケア,ふたば在宅クリニック 佐倉院,千葉県・印旛地域（佐倉市、印西市、四街道市、八千代市、千葉市、酒々井町、習志野市、船橋市）の訪問診療・往診・在宅医療">
            </li>
          </ul>
        </div>
  ...
  <div class="nav pc">
    ...
    <ul id="breadcrumb">
			...
			<?php if(!is_home() && is_single()): ?>
			  <li><a href="/news/sakura/">お知らせ一覧</a>&nbsp;&gt;&nbsp;</li>
