...
<div class="header_wrap">
	<header>
      ...
      <?php elseif (strpos($url, 'motoyawata') !== false) : ?>
				<span class="txt_00">千葉県・北西部・印旛地域の  <span>訪問診療・往診・在宅医療</span></span><br>
				<span class="txt_01">（市川市、船橋市、習志野市、八千代市、千葉市、印西市、佐倉市、四街道市、酒々井町）</span>
      <?php else : ?>
      ...
      <?php endif; ?>
        ...
        <?php elseif (strpos($url, 'motoyawata') !== false) : ?>
          <p id="header_logo">
            <a href="/motoyawata/">
              <img src="/common/images/logo_motoyawata.svg" alt="医療法人社団 千葉爽緑会 ふたば在宅クリニック 北習志野院,千葉県・北西部・印旛地域（市川市、船橋市、習志野市、八千代市、千葉市、印西市、佐倉市、四街道市、酒々井町）の在宅医療 訪問診療 訪問看護 往診">
            </a>
          </p>
          <ul class="icon_box pc">
            <li><img src="/common/images/header_icon_03.svg" alt="在宅医療(24時間365日),ふたば在宅クリニック 北習志野院,千葉県・北西部・印旛地域（市川市、船橋市、習志野市、八千代市、千葉市、印西市、佐倉市、四街道市、酒々井町）の訪問診療・往診・在宅医療"></li>
            <li><img src="/common/images/header_icon_02.svg" alt="内科 心・肺・脳,ふたば在宅クリニック 北習志野院,千葉県・北西部・印旛地域（市川市、船橋市、習志野市、八千代市、千葉市、印西市、佐倉市、四街道市、酒々井町）の訪問診療・往診・在宅医療"></li>
            <li><img src="/common/images/header_icon_01.svg" alt="がん・緩和ケア,ふたば在宅クリニック 北習志野院,千葉県・北西部・印旛地域（市川市、船橋市、習志野市、八千代市、千葉市、印西市、佐倉市、四街道市、酒々井町）の訪問診療・往診・在宅医療"></li>
          </ul>
        <?php else : ?>
        <p id="header_logo">
          <a href="/kuki/"><img src="/common/images/logo_s_v2.svg" alt="医療法人社団 爽緑会 ふたば在宅クリニック 埼玉院,埼玉県、利根地域（久喜市、加須市、幸手市、杉戸町、宮代町、白岡市、蓮田市、春日部市など）の在宅医療 訪問診療 訪問看護 往診"></a>
        </p>
        <ul class="pc icon_box">
          <li><img src="/common/images/header_icon_03.svg" alt="在宅医療(24時間365日),ふたば在宅クリニック 埼玉院,埼玉県、利根地域（久喜市、加須市、幸手市、杉戸町、宮代町、白岡市、蓮田市、春日部市など）の訪問診療・往診・在宅医療"></li>
          <li><img src="/common/images/header_icon_02.svg" alt="内科 心・肺・脳,ふたば在宅クリニック 埼玉院,埼玉県、利根地域（久喜市、加須市、幸手市、杉戸町、宮代町、白岡市、蓮田市、春日部市など）の訪問診療・往診・在宅医療"></li>
          <li><img src="/common/images/header_icon_01.svg" alt="がん・緩和ケア,ふたば在宅クリニック 埼玉院,埼玉県、利根地域（久喜市、加須市、幸手市、杉戸町、宮代町、白岡市、蓮田市、春日部市など）の訪問診療・往診・在宅医療"></li>
        </ul>
        <?php endif; ?>
			</div>
