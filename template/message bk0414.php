		...
		<section>
					...
					<dl>
						...
						<dd>
							<ul>
								...
								<li>日本脈管学会認定 脈管指導医・専門医</li>
								<li>日本血管外科学会認定 心臓血管外科専門医・修練指導者</li>
								<li>日本外科学会認定 外科指導医・専門医</li>
							</ul>
						</dd>
					</dl>
				</li>
			...
			<ul class="docter-lists">
				<li>
					<dl>
						<dt>上田 雄大</dt>
						<dd>
							<img src="/common/images/person_ueda.jpg" loading=”lazy” alt="ふたば在宅クリニック 上田 雄大" class="img">
							<ul class="txt">
								<li>総合内科</li>
							</ul>
						</dd>
          ...
          <li>
            <dl>
              <dt>鈴木 瞭介</dt>
              <dd>
								<img src="/common/images/person_suzuki_r.jpg" loading=”lazy” alt="ふたば在宅クリニック 鈴木 瞭介" class="img">
								<ul class="txt">
                  <li>総合内科</li>
                </ul>
              </dd>
						...
						<dl>
							...
							<dd>
								<ul>
									...
									<li>日本医師会認定 産業医</li>
									<li>難病指定医</li>
									<li>日本精神神経学会 指導医・専門医</li>
									<li>日本精神神経学会認定 認知症診療医</li>
									<li>臨床精神神経薬理学会 専門医</li>
									<li>日本認知症学会 指導医・専門医</li>
								</ul>
							</dd>
						</dl>
					</li>
