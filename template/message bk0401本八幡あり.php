		...
		<section>
			...
			<div class="box_wrap">
					...
					<div class="txt_box_02 message_box">
						...
						?>
							...
							<p>
								...
								医療従事者側も日々の外来診療、病棟業務に追われて疲弊している状況でした。また、急性期総合病院は長期入院が困難になっており、行き場を失う患者様も残念ながら少なくありませんでした。
							</p>
							<p>
						...
						<?php elseif (strpos($url, 'sakura') !== false) : ?>
							...
							<p>
								また、当法人の理念は「真の社会貢献」であり、日本一過酷な医療過疎地、埼玉で養ったノウハウを他の地域でも活かして、より社会貢献をしていきたいと考えるようになりました。<br>
								そのため、2021年以降、東京六本木に本部を設置し、東京（北千住・新小岩・錦糸町）、千葉（佐倉・八千代・北習志野・本八幡）と、分院展開を進めております。<br>
						...
						<?php elseif (strpos($url, 'kitanarashino') !== false || strpos($url, 'yachiyo') !== false || strpos($url, 'motoyawata') !== false) : ?>
							...
							<p>
								また、当法人の理念は「真の社会貢献」であり、日本一過酷な医療過疎地、埼玉で養ったノウハウを他の地域でも活かして、より社会貢献をしていきたいと考えるようになりました。<br>
								そのため、2021年以降、東京六本木に本部を設置し、東京（北千住・新小岩・錦糸町）、千葉（佐倉・八千代・北習志野・本八幡）と、分院展開を進めております。<br>
								特に千葉県は私自身が生まれ育った地域であり、思い入れが強いです。
							</p>
							<p>
								当法人の特徴としましては、各科の学会認定専門医を中心に、皮膚科・精神科に至るまで、複数科の医師を配置し、X線レントゲン装置、エコー、輸血まで対応できるポータブル医療機器を取り揃え、総合病院のような質の高いチーム医療を提供していることです。<br>
								また、夜間休日オンコール体制の充実を目指し、常に当院の医師・看護部が待機し、2名体制での往診を徹底しています。<br>
						...
						<?php else : ?>
							...
							<p>
								私は、これまで東京女子医科大学病院、埼玉県済生会病院に勤務し、内科、呼吸器科、救急医療、がん治療・緩和ケアを中心に診療をしてまいりました。
							</p>
							<p>
								地域の総合病院に勤務していると、外来は車椅子や杖等でご家族と通院してくる患者様であふれ、病棟では入院が長引いたり、入退院をくりかえす方が多く、ご家族とともに、身体的、精神的に疲弊していく姿を度々見かけました。<br>
								医療従事者側も日々の外来診療、病棟業務に追われて疲弊している状況でした。<br>
								また、利根地域には急性期総合病院の数が少ないため、長期入院が困難になっており、行き場を失う患者様も残念ながら少なくありませんでした。
							</p>
							<p>
								このような現状を打破し、より良い地域医療を提供するためには、患者様、ご家族はもちろん、医療従事者側の負担も減らせるような、スムーズな医療連携の構築が必要と考え、病院、外来診療所とは役割の異なる「動く病院」として、「ご自宅での予防、治療」を行う必要があると考えました。
							<p>
							...
							<p>
								皆様ご存知のように埼玉県は人口当たりの医師数が全国最低という過酷な医療過疎地であり、その中でも北東部の医療崩壊は目を見張るものがありました。<br>
								そのような環境の中で、診療はもとより、在宅医療の啓蒙、地域連携システムの構築、就労環境の整備等、がむしゃらに取り組み、厚生労働省より機能強化型在宅療養支援診療所・在宅緩和ケア充実診療所に指定されるまでになりました。<br>
								時が経ち、この地域にも新しい訪問診療所や訪問看護ステーションも増えてきて、開院当初のことを思い出すと感慨深いです。
							</p>
							<p>
								また、当法人の理念は「真の社会貢献」であり、日本一過酷な医療過疎地、ここ埼玉で養ったノウハウを他の地域でも活かして、より社会貢献をしていきたいと考えるようになりました。<br>
								そのため、2021年以降、東京六本木に本部を設置し、東京（北千住・新小岩・錦糸町）、千葉（佐倉・八千代・北習志野・本八幡）と、分院展開を進めております。
							</p>
							<p>
								当院は、爽緑会グループの本院であり、特徴としましては、各科の学会認定専門医を中心に、皮膚科・精神科に至るまで、常勤医8名・非常勤医10名の複数科の医師を配置し、X線レントゲン装置、エコー、輸血まで対応できるポータブル医療機器を取り揃え、総合病院のような質の高いチーム医療を提供していることです。<br>
								また、夜間休日オンコール体制の充実を目指し、常に当院の医師・看護部が待機し、2名体制での往診を徹底しています。<br>
								もちろん、在宅医療は看取りだけが全てではありませんが、グループ全体での年間看取り数も500人を超すようになり、全国有数の在宅診療所に成長できたと自負しております。<br>
								今後も地域の病院や訪問看護師さん・薬剤師さん・ケアマネージャーさんと連携を密に取り、一般内科疾患、心・肺・脳神経・整形疾患、がん終末期、認知症などの診療に力を入れてまいります。
							</p>
				...
				?>
					<div class="riji">
						<div class="riji_box">
							<img class="pc" src="/common/images/riji_pc_photo.jpg" srcset="/common/images/riji_pc_photo_2x.jpg 2x" loading=”lazy” alt="ふたば在宅クリニック 理事長 石井 英世">
							<img class="sp" src="/common/images/riji_sp_photo.jpg" srcset="/common/images/riji_sp_photo_2x.jpg 2x" loading=”lazy” alt="ふたば在宅クリニック 理事長 石井 英世">
							<h3>
								<span class="border">
									<span class="txt_01">理事長</span>石井 英世<br class="sp">
									<span class="txt_02">（いしい ひでよ）</span>
								</span>
							</h3>
							<div class="riji_txt message_box">
								<p>理事長の石井英世と申します。<br><br>
								私はこれまで42年間、この地域で「石井内科」という外来開業医をしてまいりました。<br>
								私自身も高齢者となりましたし、患者様も地域も一緒に歳をとりました。<br>
								地域の総合病院、外来開業医だけでは高齢化した地域の患者様をみきれない時代が到来したことを実感しています。<br><br>
								そんな中、外来中心に診療してきた、「石井内科」は2023年3月末で閉院し、訪問診療に特化した「ふたば在宅クリニック」を息子の成伸と共に開院いたしました。<br>
								これからを担う若い世代のスタッフと共に、今後も地域医療に貢献していきたいと考えております。</p>
								<div class="name_sign_02"></div>
							</div>
						</div>
					</div>
				<?php endif; ?>
			...
			<ul class="docter-lists">
				<li>
					<dl>
						<dt>石井 成伸</dt>
						<dd>
							<img src="/common/images/message_person_01.jpg" alt="石井 成伸,医療法人社団 爽緑会 ふたば在宅クリニック 北千住院 足立区 荒川区 台東区 在宅医療 訪問診療 訪問看護 往診" class="img">
							<ul class="txt">
			...
			<ul class="docter-lists">
				<li>
					<dl>
						<dt>石塚 理人</dt>
						<dd>
							<img src="/kitasenju/message/images/person_ishiduka.jpg" alt="石塚 理人,医療法人社団 爽緑会 ふたば在宅クリニック 北千住院 足立区 荒川区 台東区 在宅医療 訪問診療 訪問看護 往診" class="img">
							<ul class="txt">
			...
			<p class="department">総合内科</p>
			<ul class="docter-lists">
				<li>
					<dl>
						<dt>井之輪 俊彦</dt>
						<dd>
							<img src="/kitasenju/message/images/person_inowa_v3.jpg" alt="井之輪 俊彦,医療法人社団 爽緑会 ふたば在宅クリニック 北千住院 足立区 荒川区 台東区 在宅医療 訪問診療 訪問看護 往診" class="img">
							<ul class="txt">
			...
			<p class="department">泌尿器科</p>
			<ul class="docter-lists">
				<li>
					<dl>
						<dt>小林 秀嘉</dt>
						<dd>
							<img src="/common/images/person_kobayashi.jpg" alt="小林 秀嘉,医療法人社団 爽緑会 ふたば在宅クリニック 埼玉院,久喜市、加須市、幸手市、杉戸町、宮代町、白岡市、蓮田市、春日部市 在宅医療 訪問診療 訪問看護 往診" class="img" loading="lazy">
							<ul class="txt">
								<li>日本医師会認定産業医</li>
							</ul>
						</dd>
				...
				<ul class="docter-lists">
					<li>
						<dl>
							<dt>石井 成伸</dt>
							<dd>
								<img src="/common/images/message_person_01.jpg" loading=”lazy” alt="ふたば在宅クリニック 石井 成伸" class="img">
								<ul class="txt">
									<li>日本内科学会認定 内科認定医</li>
									<li>日本呼吸器学会認定 呼吸器専門医</li>
									<li>がん緩和ケア研修会修了医</li>
					...
					<li>
						<dl>
							...
							<dd>
								<ul>
									<li>日本内科学会認定内科医</li>
									<li>日本内科 学会 認定 総合 内科医</li>
									<li>日本医師 会認定 産業医</li>
									<li>日本循環器 学会 認定 循環器 専門医</li>
									<li>メンタルヘルス エキスパート 産業医</li>
								</ul>
							</dd>
						</dl>
					</li>
				...
				<ul class="docter-lists">
					<li>
						<dl>
							<dt>石井 英世</dt>
							<dd>
								<img src="/common/images/person_hideyo.jpg" loading=”lazy” alt="ふたば在宅クリニック 石井 英世" class="img">
								<ul class="txt">
									<li>内科</li>
									<li>消化器内科</li>
									<li>日本医師会正会員</li>
					...
					<li>
						<dl>
							<dt>柳 一夫</dt>
							<dd>
								<img src="/sakura/message/images/message_person_yanagi.jpg" loading=”lazy” alt="ふたば在宅クリニック 柳 一夫" class="img">
								<ul class="txt">
									<li>胸部外科学会認定医</li>
									<li>日本外科学会認定医</li>
									<li>がん緩和ケア研修会修了医</li>
					...
					<li>
						<dl>
							...
							<dd>
								<ul>
									<li>総合診療専門医</li>
									<li>家庭医療指導医・家庭医療専門医</li>
									<li>胸部外科認定医</li>
									<li>健康スポーツ医</li>
									<li>下肢静脈瘤焼灼術実施医</li>
									<li>身体障害者(心臓機能障害)指定医</li>
									<li>臨床研修指導医</li>
								</ul>
							</dd>
						</dl>
					...
					<li>
						<dl>
							<dt>岩本 克宜</dt>
							<dd>
								<img src="/common/images/person_iwamoto.jpg" loading=”lazy” alt="ふたば在宅クリニック 岩本 克宜" class="img">
								<ul class="txt">
				...
				<ul class="docter-lists">
					<li>
						<dl>
							<dt>新井 庸倫</dt>
							<dd>
								<img src="/kuki/message/images/person_03.jpg" alt="新井 庸倫,医療法人社団 爽緑会 ふたば在宅クリニック 埼玉院,久喜市、加須市、幸手市、杉戸町、宮代町、白岡市、蓮田市、春日部市 在宅医療 訪問診療 訪問看護 往診" class="img" loading="lazy">
								<ul class="txt">
									<li>日本消化器外科学会 認定医</li>
									<li>日本外科学会 専門医</li>
									<li>日本医師会認定 産業医</li>
				...
				<ul class="docter-lists">
					...
					<li>
						<dl>
							<dt>鈴木 亮</dt>
							<dd>
								<img src="/common/images/person_suzuki.jpg" alt="鈴木 亮,医療法人社団 爽緑会 ふたば在宅クリニック 埼玉院,久喜市、加須市、幸手市、杉戸町、宮代町、白岡市、蓮田市、春日部市 在宅医療 訪問診療 訪問看護 往診" class="img" loading="lazy">
								<ul class="txt">
									<li>心臓血管外科専門医</li>
									<li>外科専門医</li>
									<li>慶応大学外科学大学院博士号</li>
									<li>アメリカ医師国家試験(USMLE)取得</li>
								</ul>
							</dd>
						</dl>
					</li>
						...
						<dl>
							...
							<dd>
								<ul>
									...
									<li>日本医師会認定産業医</li>
									<li>難病指定医</li>
									<li>日本精神神経学会指導医・専門医</li>
									<li>日本精神神経学会認定認知症診療医</li>
									<li>臨床精神神経薬理学会専門医</li>
									<li>日本認知症学会指導医・専門医</li>
								</ul>
							</dd>
						</dl>
					</li>
		...
		<section class="staff">
				...
				<ul>
					...
					<li>
						<dl>
							...
							<dd>
								<img src="/shinkoiwa/message/images/person_saitou-k.jpg" alt="地域連携室 室長 斉藤 恵介" class="img" loading="lazy">
							</dd>
						</dl>
					</li>
					<li>
						<dl>
							<dt>事務次長 上村 秀一</dt>
							<dd>
								<img src="/common/images/person_uemura.jpg" loading=”lazy” alt="ふたば在宅クリニック 事務次長 上村 秀一" class="img" >
							</dd>
						</dl>
						</dl>
					</li>
				...
				<ul>
					...
					<li>
						<dl>
							<dt>地域連携室 室長 斉藤 恵介</dt>
							<dd>
								<img src="/sakura/message/images/person_saitou-k.jpg" loading=”lazy” alt="ふたば在宅クリニック 地域連携室 室長 斉藤 恵介" class="img" >
							</dd>
						</dl>
					</li>
					<li>
						<dl>
							<dt>事務次長 大野 紘崇</dt>
							<dd>
								<img src="/sakura/message/images/message_person_oono.jpg" loading=”lazy” alt="ふたば在宅クリニック 事務次長 大野 紘崇" class="img" >
							</dd>
						</dl>
					</li>
					<li>
						<dl>
							<dt>事務次長 北見 竜也</dt>
							<dd>
								<img src="/common/images/person_kitami.jpg" loading=”lazy” alt="ふたば在宅クリニック 事務次長 北見 竜也" class="img" >
							</dd>
						</dl>
					</li>
					<li>
				...
				<ul>
					...
					<li>
						<dl>
							<dt>地域連携室 室長 斉藤 恵介</dt>
							<dd>
								<img src="/yachiyo/message/images/person_saitou-k.jpg" loading=”lazy” alt="ふたば在宅クリニック 地域連携室 室長 斉藤 恵介" class="img" >
							</dd>
						</dl>
					</li>
					<li>
			...
			<?php else : ?>
				<ul>
					...
					<li class="pink">
						<dl>
							<dt>地域連携室 地域連携看護師 萩原 尚子</dt>
							<dd>
								<img src="/kuki/message/images/person_hagiwara.jpg" alt="地域連携室 地域連携看護師 萩原 尚子,医療法人社団 爽緑会 ふたば在宅クリニック 埼玉院,久喜市、加須市、幸手市、杉戸町、宮代町、白岡市、蓮田市、春日部市 在宅医療 訪問診療 訪問看護 往診" class="img" loading="lazy">
							</dd>
						</dl>
					</li>
				</ul>
